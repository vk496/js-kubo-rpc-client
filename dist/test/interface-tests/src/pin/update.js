...
export function testUpdate(factory, options) {
    ...
    describe('.pin.update', function () {
        ...
        before(async function () {
            ...
            await drain(ipfs.addAll(fixtures.files.map(file => ({ content: file.data })), {
                pin: false
            }));
            await drain(ipfs.addAll(fixtures.directory.files.map(file => ({
                path: file.path,
                content: file.data
            })), {
                pin: false
